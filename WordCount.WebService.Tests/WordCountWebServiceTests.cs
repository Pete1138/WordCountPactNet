...
{
    public class WordCountWebServiceTests : IUseFixture<WordCountWebServiceApiPact>
    {
        private IMockProviderService _mockProviderService;
        private string _mockProviderServiceBaseUri;

        public void SetFixture(WordCountWebServiceApiPact data)
        {
